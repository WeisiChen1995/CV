...
I am a highly disciplined and hard-working professional with a strong passion for\\ technology, programming, data analysis, data visualization, and statistical modeling.\\ Leveraging a unique blend of training in pharmacy and health data science,\\
...
\begin{longtable}{llp{14cm}}
    ...
    & \multicolumn{2}{p{0.8\textwidth}}{- Executing statistical analysis of linked data (e.g., logistic regression and reverse probability weighting), with academic supervision, using statistical packages R and SAS.} \\[5pt]
    & \multicolumn{2}{p{0.8\textwidth}}{- Drafting scientific papers, protocols, and conference abstracts, with academic supervision.} \\[5pt]
    ...
    \textbf{Feb 2023 - Dec 2023} & \textbf{University of Sydney}, Sydney, NSW & \\
    ...
    & \multicolumn{2}{p{0.8\textwidth}}{Investigating high-risk prescribing in Australian older adults.} \\[10pt]
...
\raggedright \underline{\textbf{Clinical-focused Posistion}}

\vspace{-10pt}
\begin{longtable}{llp{14cm}}

    \textbf{Mar 2021 - Dec 2024} & \textbf{Bondi Junction Pharmacy}, Sydney, NSW & \\
    & \textbf{Pharmacist in charge (FTE 0.2)}\\[5pt]

    \textbf{Mar 2021 - Dec 2024} & \textbf{Blooms the Chemsit Bondi Junction}, Sydney, NSW & \\
    ...
    \textbf{Dec 2018 - March 2020} & \textbf{Chemist Warehouse Randwick}, Sydney, NSW & \\
