...
\begin{longtable}{llp{14cm}}
    ...
    & \multicolumn{2}{p{0.8\textwidth}}{- Executing statistical analysis of linked data (e.g., logistic regression and inverse probability of treatment weighting), with academic supervision, using statistical packages R and SAS.} \\[5pt]
    ...
    & \multicolumn{2}{p{0.8\textwidth}}{- Conducting data analysis and statistical modeling (e.g., logistic regression) relevant to the project, under the acedemic supervision.} \\
